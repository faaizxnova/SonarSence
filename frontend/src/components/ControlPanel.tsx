...
/**
 * Control Panel — top command bar with dataset selection, pipeline
 * controls, the physics/MVB inspectors, live AUV scan toggle, and
  ...
  return (
    <header className="bg-[var(--bg-secondary)] border-b border-[var(--border-subtle)] px-4 py-2.5 flex items-center justify-between flex-wrap gap-3">
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-[var(--accent-primary)] text-white shadow-sm">
          <svg
            width="18"
            height="18"
            viewBox="0 0 24 24"
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <div className="flex items-center gap-2 rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-secondary)] px-3 py-1.5 shadow-sm">
          <label htmlFor="dataset-select" className="text-[11px] font-mono font-bold text-[var(--text-primary)] uppercase">
            Dataset:
          </label>
          <select
            id="dataset-select"
        ...
        <button
          ...
          aria-label="Open 3D MVB inspector"
        >
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <button
          ...
          aria-label="Open physics inspector"
        >
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <button
          ...
          aria-pressed={isLiveScanning}
          aria-label={isLiveScanning ? "Stop live AUV scan simulation" : "Start live AUV scan simulation"}
          className={`btn-secondary ${isLiveScanning ? "!border-[var(--accent-live)] !text-[var(--accent-live)]" : ""}`}
        ...
        <button
          ...
          title="Export clearance dossier as PDF"
          aria-label="Export clearance dossier as PDF"
        >
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <button
          ...
          aria-label="Export anomaly report as JSON"
        >
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <button
          ...
          aria-label="Export anomaly report as CSV"
        >
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3" />
          </svg>
      ...
      <div className="flex items-center gap-2.5">
        ...
        <button
          ...
          aria-label={audioEnabled ? "Mute sonar ping audio" : "Enable sonar ping audio"}
        >
          {audioEnabled ? (
        ...
        {/* Target Count Badge */}
        {detectionCount > 0 && (
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full font-mono text-[11px] font-bold bg-[var(--bg-tertiary)] text-[var(--text-primary)] border border-[var(--border-subtle)]">
