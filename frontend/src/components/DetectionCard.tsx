...
/**
 * Detection Card — full metadata for a selected debris detection:
 * classification, threat badge, physical dimensions & 3D MVB volume,
 * WGS84 coordinates, acoustic parameters, and confidence score.
 */
    ...
    <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm" style={{ maxWidth: 320 }}>
      ...
      <div className="space-y-2 font-mono text-xs">
        ...
        <DataRow
          ...
          value={`${props.dimensions.length_m.toFixed(2)} × ${props.dimensions.width_m.toFixed(2)} × ${props.dimensions.height_m.toFixed(2)} m`}
        />
        ...
        <DataRow label="Seabed Depth" value={`${props.depth_m.toFixed(1)} m`} />
        ...
        <div className="pt-2 mt-2 border-t border-slate-100">
          ...
          <DataRow
            label="H_towfish"
            value={`${props.mensuration.parameters.H_towfish_m.toFixed(1)} m`}
          />
          <DataRow
            label="R_slant"
